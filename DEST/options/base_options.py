...
class BaseOptions():
    ...
    def initialize(self, parser):
        # base define
        parser.add_argument('--name', type=str, default='Celeba', help='name of the experiment.')
        parser.add_argument('--model', type=str, default='DEST', help='name of the model type.')
        parser.add_argument('--mask_type', type=int, default=[0,1,2],
        ...
        # data pattern define
        parser.add_argument('--img_file', type=str, default=r'D:\datasets\CelebA-HQ\Celeba-HQ_test', help='training and testing dataset')
